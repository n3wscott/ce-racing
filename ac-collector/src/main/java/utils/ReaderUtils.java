...
public class ReaderUtils {
    ...
    public static int readUInt32LE(byte[] var0, int var1) {
        return var0[var1 + 3] << 24 | (var0[var1 + 2] & 255) << 16 | (var0[var1 + 1] & 255) << 8 | (var0[var1 + 0] & 255);
    }
    ...
    public static String readStringUTF16LE(byte[] var0, int var1, int var2) {
        ...
        return new String(var0, var1, var3, StandardCharsets.UTF_16LE);
    }
    ...
    public static float[] read3Float32(byte[] var0, int var1) {
        return new float[]{readFloat32(var0, var1), readFloat32(var0, var1 + 4), readFloat32(var0, var1 + 8)};
    }

    public static float[] read4Float32(byte[] var0, int var1) {
        return new float[]{readFloat32(var0, var1), readFloat32(var0, var1 + 4), readFloat32(var0, var1 + 8), readFloat32(var0, var1 + 12)};
    }
}
